...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field apsr_m2m on 'FloodExtent'
        db.create_table('predictive_floodextent_apsr_m2m', (
        ...
        db.create_unique('predictive_floodextent_apsr_m2m', ['floodextent_id', 'areaofpotentialsignificantrisk_id'])


    def backwards(self, orm):
        # Removing M2M table for field apsr_m2m on 'FloodExtent'
        db.delete_table('predictive_floodextent_apsr_m2m')
    ...
    models = {
        ...
        'predictive.floodextent': {
            ...
            'apsr_m2m': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'apsr_m2m'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['predictive.AreaOfPotentialSignificantRisk']"}),
