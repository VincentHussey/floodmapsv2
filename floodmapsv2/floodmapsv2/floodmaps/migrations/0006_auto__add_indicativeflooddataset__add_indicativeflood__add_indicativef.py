...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HistoricFlood.geometry'
        db.alter_column('floodmaps_historicflood', 'geometry', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=2157))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'HistoricFlood.geometry'
        db.alter_column('floodmaps_historicflood', 'geometry', self.gf('django.contrib.gis.db.models.fields.PointField')())
    ...
    models = {
        ...
        'floodmaps.indicativeflood': {
            'Meta': {'object_name': 'IndicativeFlood'},
