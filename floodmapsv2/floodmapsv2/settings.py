...
SECRET_KEY = 'h*1_gy^dcba%t#+*fnv_udchzr^*363lsk)0-d765oyn$6_anw'
...
ROOT_URLCONF = 'floodmapsv2.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'floodmapsv2.wsgi.application'
...
TEMPLATE_DIRS = (
    ...
    PROJECT_ROOT + '/templates/predictive/',
)
